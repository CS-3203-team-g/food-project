...
public class GetTotalRecipes implements HttpHandler {

    private static final Logger logger = LoggerFactory.getLogger(GetTotalRecipes.class);
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        logger.debug("Getting total recipes");
