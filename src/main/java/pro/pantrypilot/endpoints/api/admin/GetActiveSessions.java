...
public class GetActiveSessions implements HttpHandler {

    private static final Logger logger = LoggerFactory.getLogger(GetActiveSessions.class);
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        logger.debug("Getting total active sessions");
        int totalSessions = SessionsDatabase.getActiveUsersLast30m();

        String response = String.valueOf(totalSessions);
